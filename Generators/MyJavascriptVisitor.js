...
export class MyJavascriptVisitor extends AstVisitor {
    ...
    InitVisitors() {
        ...
        this.SetVisitor( 'set_delay_interval',      elem => this.Visit_SetDelayInterval(elem) );
        ...
        this.SetVisitor( 'delay_interval',          elem => this.Visit_DelayInterval(elem) );
...
element.removeEventListener('keypress',${code.listener},false);`);
    ...
    Visit_DelayInterval(elem)               {this.stack.push(``);}
